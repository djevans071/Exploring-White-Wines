...
basic_histogram('volatile.acidity') + scale_x_log10()
...
basic_histogram('sulphates') + scale_x_log10()
...
basic_histogram('alcohol', bins = 75)
```
...
```{r}
high_low <- if_else(wines$quality > 6, 'high', 'low')
high_low <- factor(high_low, c('low', 'high'))
